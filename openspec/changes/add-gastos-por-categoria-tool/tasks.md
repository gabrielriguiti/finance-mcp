...
- [x] 2.1 Validar `gastos_por_categoria` no Claude Desktop (já configurado via `claude_desktop_config.json`): período com gastos, período sem gastos, filtro por conta, e conta inexistente.
