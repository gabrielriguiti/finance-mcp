...
- [x] 4.1 Configurar o servidor no Claude Desktop (`claude_desktop_config.json`) e validar `get_saldo` end-to-end: com conta existente, sem conta, e com conta inexistente.
